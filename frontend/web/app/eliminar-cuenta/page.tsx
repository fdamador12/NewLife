...
function resolveMobileApiUrl(): string {
  ...
  if (adminUrl) return adminUrl.replace("5180", "5181")
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Cuenta protegida (admin/superadmin)
  ...
  return (
    <div className="min-h-screen bg-[#f8f6f3]">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        {estado === "success" && (
          <div className="bg-white rounded-2xl border border-[#e5e5e5] p-8 text-center">
            ...
            <p className="text-[#737373] text-sm leading-relaxed mb-6">
              La cuenta asociada a{" "}
              <span className="font-medium text-[#1a1a1a]">{email}</span> ha sido
        ...
        {/* ─── Estado: cuenta ya estaba eliminada ─────────────────── */}
        {estado === "already-deleted" && (
          <div className="bg-white rounded-2xl border border-[#e5e5e5] p-8 text-center">
            ...
            <p className="text-[#737373] text-sm leading-relaxed mb-6">
              La cuenta asociada a{" "}
              <span className="font-medium text-[#1a1a1a]">{email}</span> ya
        ...
        {/* ─── Estado: cuenta protegida (admin/superadmin) ────────── */}
        ...
        {(estado === "idle" || estado === "loading" || estado === "error") && (
          <>
            {/* Encabezado limpio sin ícono grande */}
            <div className="mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-[#a3a3a3]">
                    Necesitamos tu contraseña para verificar que eres el dueño de la cuenta.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-3 pt-2">
                  ...
                  <label htmlFor="confirmacion" className="text-sm text-[#4a4a4a] cursor-pointer leading-relaxed">
                    ...
                    <span className="font-medium">inmediata e irreversible</span> y que
